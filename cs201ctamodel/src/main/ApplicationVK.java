...
public class ApplicationVK {
	...
	public static void main(String[] args) {
		...
		cta.addRoute("95th/Dan Ryan", RouteType.RED_LINE, new int[]{30173, 30228, 30021, 30252, 30065, 30170, 30268, 30067, 30230, 30150, 30106, 30017, 30274, 30256, 30234, 30126, 30122, 30280, 30065, 30290, 30212, 30110, 30286, 30270, 30194, 30037, 30238, 30224, 30178, 30192, 30047, 30276, 30089});
